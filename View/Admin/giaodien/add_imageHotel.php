...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Thêm mới ảnh khách sạn</h4>
                <form class="forms-sample" action="index.php?url=them-moi-anh-khach-san" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="">Mã ảnh</label>
                        <input disabled name="id_img" type="text" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="">Ảnh</label>
